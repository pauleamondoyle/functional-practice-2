...
function pluck(list, propertyName) {
    ...
    list.forEach(function(element){
        var propValue = element[propertyName]
...
function reject(list, predicate) {
    // YOUR CODE HERE
    var resultsArray = list.filter(function(element){
...
function where(list, properties) {
    // YOUR CODE HERE
    var resultsArray = list.filter(function(play){
        for(var keyElement in properties){
            if(play[keyElement]!==properties[keyElement]) return false
